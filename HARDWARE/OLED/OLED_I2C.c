...
{	
    ...
    GPIO_Initure.Pin=GPIO_PIN_10|GPIO_PIN_11;								//PB10，B11
...
void OLED_ShiftOut8Bit(unsigned char sendbyte)
{
		unsigned char j=8;
		OLED_SDA_OUT();
		for(;j>0;j--)
...
void OLED_ShiftOutnBit(unsigned char sendbyte,unsigned char shiftnumber)
{       
		unsigned char  j;
		OLED_SDA_OUT(); 
...
unsigned char OLED_ShiftIn8Bit(void)
{
		...
		while(i--)
		{
				delay_us(2);	
				OLED_SCL_ON;
				receivebyte=(receivebyte<<1)|ReadOLED_SDA;
				delay_us(2);	    
				OLED_SCL_OFF;
		}	
		return(receivebyte); 
...
unsigned char OLED_ShiftInnBit(unsigned char shiftinnumber)
{
		unsigned char receivebyte=0,i;
		OLED_SDA_IN();
		i=shiftinnumber;					
		OLED_SCL_OFF;
		while(i--)
...
//{
//		OLED_Start();
//		OLED_ShiftOut8Bit(0x00);//???
//		OLED_waitAck();
//		OLED_ShiftOut8Bit(addr);
//		OLED_waitAck();
//		OLED_ShiftOut8Bit(data);
//		OLED_waitAck();
//		OLED_Stop();
//}
...
{
	  OLED_Start();
		OLED_ShiftOut8Bit(0x78);
	  OLED_ShiftOut8Bit(0x00);
	  OLED_ShiftOut8Bit(I2C_Command);
	  OLED_Stop();
}
...
void WriteDat(unsigned char I2C_Data)//写数据
{
	  OLED_Start();
		OLED_ShiftOut8Bit(0x78);
	  OLED_ShiftOut8Bit(0x40);
	  OLED_ShiftOut8Bit(I2C_Data);
	  OLED_Stop();
}
