...
//     Fq=800/4=200Mhz
//返回值:0,成功;1,失败。
void Stm32_Clock_Init(u32 plln,u32 pllm,u32 pllp,u32 pllq)   // (160,5,2,4);   (80,5,2,2);   
{
...
//	RCC->D1CCIPR=RCC->D1CCIPR&(~0x30);
//  RCC->D1CCIPR=RCC->D1CCIPR|0x10;     //将pll_q CK时钟选做QSPI内核的外设时钟	
